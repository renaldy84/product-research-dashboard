...
export default function EditProductPage() {
  ...
  const { products, categories, setCategories, updateProduct } = useProductStore();
  ...
  const handleGenerateField = async (field: string) => {
    ...
    try {
      ...
      // Auto-save to database immediately after generation completes
      try {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-600">Perbarui informasi produk</p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="Deskripsi lengkap produk untuk marketplace"
                rows={4}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
              />
            </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="Siapa target konsumen produk ini?"
                rows={3}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="Bagaimana indikasi permintaan pasar?"
                rows={3}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
              />
            </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="Siapa saja kompetitor utama?"
                rows={3}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="Apa unique selling point yang bisa menjadi angle iklan?"
                rows={3}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="Masalah apa yang diselesaikan produk ini?"
                rows={3}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
              />
            </div>
